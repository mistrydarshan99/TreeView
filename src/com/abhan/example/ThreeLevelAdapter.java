...
class ThreeLevelAdapter extends AbstractTreeViewAdapter<Long> {
	
	private static final String TAG = "ThreeLevelAdapter";

    public ThreeLevelAdapter(final TreeViewListDemo treeViewListDemo,
    ...
    public LinearLayout updateView(final View view,
        ...
        if (level == 0) {
        	...
        	// Child
            final TextView txtChildTitle = (TextView) viewLayout
                    .findViewById(R.id.childTitle);
            final TextView txtChildCategoryText = (TextView) viewLayout
                    .findViewById(R.id.childCategoryText);
            long id = treeNodeInfo.getId();
            txtChildTitle.setText("Sub Level " + id);
            txtChildCategoryText.setText("Sub Level Text " + String.valueOf(id) + " Goes Here");
        }
        return viewLayout;
    }
